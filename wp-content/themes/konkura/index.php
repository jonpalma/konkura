                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="item active">
                          <img src="<?php bloginfo('template_url')?>/img/banner/1.jpg" class="img-responsive" alt="">
                          <div class="container">
                            <div class="carousel-caption">
                              <h1>KONKURA</h1>
                              <p>Diseñamos soluciones integrales que contribuyen al desarrollo de las organizaciones y sus colaboradores.</p>
                            </div>
                          </div>
                        </div>
                       <div class="item">
